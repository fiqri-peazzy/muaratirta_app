...
<body>
    ...
    <table style="width:100%;margin-bottom:10px;">
        <tr>
            <td style="width:60%;vertical-align:middle;">
                <div style="font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:0.5px;color:#1c3f7c;">Laporan Keluhan Pelanggan</div>
                <div style="font-size:8px;color:#5a6472;padding-top:1px;">No. Pengaduan: <strong style="color:#1c3f7c;">' . $no_pengaduan . '</strong></div>
            </td>
    ...
    <table style="width:100%;margin-bottom:10px;">
        <tr>
            <td style="border:1px solid #c7d4e8;padding:8px;font-size:10px;min-height:60px;">' . nl2br(htmlspecialchars($keluhan['isi_pengaduan'])) . '</td>
        </tr>
    </table>
    ...
    <table style="width:100%;margin-bottom:10px;">
        ...
        ? '<table style="width:100%;">
                        <tr>
                            <td align="center" valign="middle" style="border:1px solid #c7d4e8;height:170px;text-align:center;vertical-align:middle;">
        ...
        : '<table style="width:100%;">
                        <tr>
                            <td align="center" valign="middle" style="border:1px dashed #c7d4e8;background-color:#fafbfc;height:170px;text-align:center;vertical-align:middle;">
                                <span style="font-size:9px;color:#a8afba;">Foto tidak tersedia</span>
                            </td>
                        </tr>
                    </table>') . '
            </td>
    ...
    <table style="width:100%;margin-top:14px;border-top:1px solid #d8dee6;padding-top:5px;">
        <tr>
            ...
            <td style="width:40%;font-size:7px;color:#9a9a9a;text-align:right;">' . $no_pengaduan . '</td>
        </tr>
    </table>
