...
<?php include(ROOT_PATH . '/app/controllers/galeri.php'); ?>
                        ...
                        <nav aria-label="breadcrumb" role="navigation">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">
                                    <a href="<?php echo BASE_URL . '/admin/index.php?page-title=Dashboard-Admin' ?>">Beranda</a>
                                </li>
            ...
            <div class="pd-20 card-box mb-30">
                <form method="post" enctype="multipart/form-data" id="my-awesome-dropzone">
                    ...
                    <div class="form-group pl-3 row">
                        <button type="submit" class="btn btn-primary" name="add-gallery">Submit</button>
                    </div>
