            ...
            <div class="card-box pd-20">
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-12">
                            <textarea class="textarea_editor form-control border-radius-0" name="deskripsi"></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <button type="submit" class="btn btn-primary" name="add-info">Submit</button>
                    </div>
