    ...
    <div class="main-container">
        <div class="xs-pd-20-10 pd-ltr-20">
            ...
            <div class="card-box pd-20">
                <form method="post" action="<?= BASE_URL . '/admin/struktur-organisasi/add-staff-handler.php' ?>"
                    enctype="multipart/form-data" id="add-staff-form">
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">* Nama Lengkap</label>
                        <div class="col-lg-6">
                            <input class="form-control" type="text" name="nm_lengkap">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <select name="kd_bagian" id="" class="selectpicker form-control"
                                ...
                                <option value="<?= $bgn['kd_bagian'] ?>"><?= $bgn['bagian'] ?></option>
                                <?php endforeach; ?>
                    ...
                    <div class="form-group row">
                        <img src="" id="frame" alt="" class="img-fluid col-lg-6">
                    </div>

                    <div class="form-group row pl-2">
                        <button type="submit" class="btn btn-primary" name="add-staff">Submit</button>
                    </div>
