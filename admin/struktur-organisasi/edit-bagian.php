...
adminOnly();
if (isset($_GET['id'])) {
    $bagian = selectOne('jabatan', ['kd_bagian' => $_GET['id']]);
} else {
        ...
        <div class="xs-pd-20-10 pd-ltr-20">
            ...
            <div class="card-box pd-20">
                <form method="post" enctype="multipart/form-data">
                    ...
                    <input class="form-control" type="hidden" name="kd_bagian" value="<?= $bagian['kd_bagian'] ?>">
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">* Bagian</label>
                        <div class="col-lg-4">
                            <input class="form-control" type="text" value="<?= $bagian['bagian'] ?>" name="bagian">
                        </div>
                    </div>
                    ...
                    <div class="form-group row pl-4">
                        <button type="submit" class="btn btn-primary" name="edit-bagian">Submit</button>
                    </div>
