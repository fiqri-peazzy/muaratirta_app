                                                                ...
                                                                <tr>
                                                                    <td class="v-text-align"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="https://cdn.templates.unlayer.com/assets/1676615059956-password.gif"
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <h1 class="v-text-align v-font-size"
                                                                ...
                                                                <span><strong>Your Password has been
                                                                        Changed</strong></span>
                                                            </h1>
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <h1 class="v-text-align v-font-size"
                                                                ...
                                                                <span><span><span><span><strong>Subject: Password Change
                                                                                    Confirmation</strong></span></span></span></span>
                                                            </h1>
                                                            <!--[if mso]></td></tr></table><![endif]-->
                                                        ...
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-text-align v-font-size"
                                                                ...
                                                                <p style="line-height: 140%;">Hi
                                                                    <?php echo $user['nm_lengkap'] ?>,</p>
                                                                <p style="line-height: 140%;"> </p>
                                                                <p style="line-height: 140%;">This is to confirm that
                                                                    the password for your account has been successfully
                                                                    changed. Your account is now secured with the new
                                                                    password that you have set.</p>
                                                                <p style="line-height: 140%;"> </p>
                                                                <p style="line-height: 140%;">Your New Password :
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-text-align" align="center">
                                                                <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="" style="height:37px; v-text-anchor:middle; width:155px;" arcsize="11%"  stroke="f" fillcolor="#316b94"><w:anchorlock/><center style="color:#FFFFFF;"><![endif]-->
                                                                <a href="" target="_blank"
                                                                    ...
                                                                    <span
                                                                        style="display:block;padding:10px 20px;line-height:120%;"><span
                                                                            style="line-height: 16.8px;">Go to my
                                                                            Account</span></span>
                                                                </a>
